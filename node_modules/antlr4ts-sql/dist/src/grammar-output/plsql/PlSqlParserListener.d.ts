...
import { Table_ref_aux_internalContext } from "./PlSqlParser";
 ...
 * `PlSqlParser`.
 */
export interface PlSqlParserListener extends ParseTreeListener {
    /**
    ...
    /**
     * Enter a parse tree produced by `PlSqlParser.table_ref_aux_internal`.
     * @param ctx the parse tree
     */
    enterTable_ref_aux_internal?: (ctx: Table_ref_aux_internalContext) => void;
    /**
     * Exit a parse tree produced by `PlSqlParser.table_ref_aux_internal`.
     * @param ctx the parse tree
     */
    exitTable_ref_aux_internal?: (ctx: Table_ref_aux_internalContext) => void;
    /**
